...
![]({{ site.url }}{{ site.baseurl }}/images/researchpic/flake-contacted.jpg){: style="width: 40%; display: block; margin: 0 auto;"}
<p style="text-align: center;"><em>Figure: WSe₂ flake on silica contacted with gold gates.</em></p>
...
![]({{ site.url }}{{ site.baseurl }}/images/slider/QX_figure.png){: style="width: 60%; display: block; margin: 0 auto;"}
<p style="text-align: center;"><em>Figure: Interlayer excitons in bilayer van der Waals heterostructure.</em></p>
