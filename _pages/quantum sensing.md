...
**Quantum Learning Systems** - We are developing quantum sensing tools by adding self-optimising algorithms that adapt measurement settings in real time, cutting down the long data acquisition times. See more: [Link]({{ site.url }}{{ site.baseurl }}/research/quantum-learning)
